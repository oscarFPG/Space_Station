...
export default class BasedEnemy extends Phaser.GameObjects.Container {
    ...
    constructor(scene, x, y, texture, weaponName) {
        super(scene, x, y);
        ...
        this.enemySprite = scene.add.sprite(28, 32, this.texture).setOrigin(0.5, 0.5);
        ...
        this.weapon = WeaponFactory.createWeapon(this.weaponName, this.scene, this.weaponOffset)
        ...
        this.state = 'patrol';          
        this._atributos.shootingRange = 540;             
    ...
    receiveDamage(damage) {
        ...
        this._atributos.health -= damage;
        if(this._atributos.health > 0) {
    ...
    preUpdate(time, delta) {  
        ...
        if (distanceToPlayer <= this._atributos.shootingRange) {
        ...
        if (this.state === 'perseguir') {
            ...
            if (distanceToPlayer <= this._atributos.shootingRange && time > this.lastShotTime + this._atributos.fireRate) {
